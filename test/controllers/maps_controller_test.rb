...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { difficulty: @map.difficulty, name: @map.name, slug: @map.slug } }, as: :json
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { difficulty: @map.difficulty, name: @map.name, slug: @map.slug } }, as: :json
    assert_response 200
  end
